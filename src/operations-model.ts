...
export const refsKinds: ReadonlySet<OperationKind> = new Set(["commit", "amend", "undoCommit", "fetch", "branchCreate", "branchSwitch", "branchTrack", "checkout", "branchRename", "branchDelete", "setUpstream", "pull", "push", "merge", "mergeAbort", "mergeCommit"]);
...
export const switchKinds: ReadonlySet<OperationKind> = new Set(["branchCreate", "branchSwitch", "branchTrack", "checkout", "stashApply", "stashPop", "stashPush", "pull", "merge", "mergeAbort"]);
