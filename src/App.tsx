...
export default function App() {
  ...
  const special = pair && !imageDisplay ? describeSpecial(pair, [endpoints[0], endpoints[1]]) : null;
  const readingNotices: string[] = [];
  if (pair && !imageDisplay) {
