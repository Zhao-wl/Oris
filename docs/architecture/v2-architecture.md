...
状态：工程设计。§1–§5、§7 已由任务 V2-01 实施（2026-09-24），实施中与本文不一致之处及原因见 [V2-01 结果](../validation/v2-01-results.md#与技术方案不一致之处)；其余章节尚未实施。主栈沿用 [V1 技术方案](v1-architecture.md)；本文描述二期的增量与修订。
