...
| [06 双平台性能与可安装发布包](06-performance-release.md) | 全范围真实验收 → 性能预算 → 双平台安装/签名；一二期合并发布（V2-D19） | 03、04、05 与二期 V2-01–V2-06 通过 | Awaiting acceptance（性能未达标项待用户决定、签名、macOS 最终版本复测）：Windows 功能追溯矩阵与发布准备完成（[结果](../validation/v1-06-release-results.md)）；发布性能测试 24 项中 21 项达标（[性能](../validation/v1-06-performance.md)） |
